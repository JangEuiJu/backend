...
-- t1 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `t1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `t1`;
...
-- 테이블 데이터 t1.city:~4,095 rows (대략적) 내보내기
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Info`) VALUES
	...
	(3808, 'Austin', 'USA', 'Texas', '{"Population": 656